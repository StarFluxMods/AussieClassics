...
{
    public class RoadWithCars : SceneAppliance
    {
        public override string UniqueNameID => "RoadWithCars";
        public override GameObject Prefab => Mod.Bundle.LoadAsset<GameObject>("RoadWithCars").AssignMaterialsByNames();
